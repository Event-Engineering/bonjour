...
import {default as ServiceObj, serviceQuery as wildcardService} from './service-obj.js';
...
export default class Browser extends EventEmitter {
	...
	#buildServicesFor(name, packet, referer) {
		...
		.map((ptr) => {
			...
			let service = ServiceObj.fromFqdn(srvR.name, {...srvR.data, referer, txtSettings: this._opts.txt});
